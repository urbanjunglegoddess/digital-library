...
slug: stats-metric-card
category: Data Display
status: built
summary: "The single most-glanced-at component in any dashboard. A tile that turns one number into an instant answer: \"how are we doing right now, and is it getting…"
tags: [data, stats, metric, card]
---
