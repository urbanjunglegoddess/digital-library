...
status: built
summary: "The component for selecting colors with precision through gradient areas, sliders, and text inputs. Here's everything from first principles to production code."
tags: [forms, color, picker]
---
