...
slug: floating-action-button-fab
category: Actions
status: built
summary: "A circular, elevated button pinned to a fixed corner of the viewport that carries the single most important action on a screen — and, in its speed-dial form,…"
tags: [action, floating, button, fab]
---
