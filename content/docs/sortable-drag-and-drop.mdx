---
name: "Sortable - Drag and Drop"
slug: sortable-drag-and-drop
category: Layout & Structure
status: built
summary: "Reordering by dragging is the interaction users reach for without thinking — and the one that fails hardest for keyboard and screen-reader users when built…"
tags: [layout, sortable, drag, drop]
---
