...
category: Navigation
status: built
summary: "The panel that slides in from an edge, covers what you were doing, and slides back out. Simple to look at, deceptively deep to build right — here's everything…"
