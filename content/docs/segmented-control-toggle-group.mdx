---
name: "Segmented Control-Toggle Group"
slug: segmented-control-toggle-group
category: Actions
status: built
summary: "The button-group picker for switching between mutually exclusive options. Here's everything from first principles to production code."
tags: [action, segmented, control, toggle]
---
