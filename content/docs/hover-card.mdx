...
status: built
summary: "The rich preview panel that appears on hover, giving users context without navigating away. Here's everything from first principles to production code."
tags: [overlay, hover, card]
---
