...
status: built
summary: "A slim, site-wide broadcast strip — the single loudest inch of the page. Here's everything from first principles to production code, at the same depth as the…"
tags: [layout, announcement]
---
