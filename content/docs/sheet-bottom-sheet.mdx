...
slug: sheet-bottom-sheet
category: Overlays & Popouts
status: built
summary: "The mobile-first slide-up panel that's replaced modals on touch devices. Here's everything from first principles to production code."
tags: [overlay, sheet, bottom]
---
