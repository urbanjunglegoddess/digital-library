...
status: built
summary: "The component that shows events in chronological sequence connected by a visual thread. Here's everything from first principles to production code."
tags: [data, timeline]
---
