...
status: built
summary: "Split panes divided by a draggable gutter — the thing that lets you widen the code pane and shrink the file tree in VS Code. Deceptively simple to fake with a…"
